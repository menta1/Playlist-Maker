...
import com.example.playlistmaker.databinding.PlaylistItemPlayerBinding
import java.io.File

class PlayerAddToPlaylistAdapter(private val listener: Listener) :
    RecyclerView.Adapter<PlayerAddToPlaylistAdapter.PlaylistHolder>() {
    ...
    class PlaylistHolder(itemPlaylist: View) : RecyclerView.ViewHolder(itemPlaylist) {
        ...
        private val binding = PlaylistItemPlayerBinding.bind(itemPlaylist)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaylistHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.playlist_item_player, parent, false)
